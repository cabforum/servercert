...
3. If both a Registration Number (or similar) has not been assigned and the readily verifiable date of creation is not available: appropriate language to indicate that the Subject is a Government Entity.
