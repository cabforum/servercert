...
| `organizationalUnitName` _Effective 2022-12-12_ | "MUST NOT" for Root CA Certificates defined in section 7.1.2.1 or TLS Subordinate CA Certificates defined in section 7.1.2.3 and "SHOULD NOT" for all other CAs | -           | -           |
