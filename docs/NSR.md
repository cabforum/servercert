...
b. Identify those Certificate Systems under the control of CA or Delegated Third Party Trusted Roles capable of monitoring and logging system activity and log and continuously monitor the events specified in Section 5.4.1 of the Baseline Requirements for the Issuance and Management of Publicly-Trusted Certificates;
